        ...
        <form class="mt-10">
          <div
            ...
            <div class="lg:col-span-2 lg:col-start-1 lg:pb-16 lg:pr-8">
                  ...
                  <div class="grid grid-cols-4 gap-4 sm:grid-cols-7 lg:grid-cols-4">
                    <RadioGroupOption as="template" v-for="size in sneaker.sizes" :key="size.size" :value="size.size"
                      ...
                      <div
                        ...
                        <span
                          :class="['border-2', checked ? 'border-blue-500' : 'border-transparent', 'pointer-events-none absolute -inset-px rounded-md']"
                          aria-hidden="true" />
                      </div>
                    </RadioGroupOption>
                  </div>
              ...
              <Link v-else method="put" as="button" type="button" href="#"
