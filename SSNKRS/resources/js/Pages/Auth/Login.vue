          ...
          <div class="md:max-w-md w-full sm:px-6 py-4">
            <form @submit.prevent="submit">
              <div class="mb-12">
                ...
                <p class="text-sm mt-4 ">No tienes cuenta? <a :href="route('register')" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Crea una cuenta aqui</a></p>
              </div>
              <div>
              ...
              <div class="flex items-center justify-between gap-2 mt-5">
                <div class="flex items-center">
                  <Checkbox name="remember" v-model:checked="form.remember" class="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"  />
              ...
              <div class="mt-12">
                <button class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded-full text-white bg-blue-600 hover:bg-blue-700 focus:outline-none" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Iniciar Sessión
                </button>
