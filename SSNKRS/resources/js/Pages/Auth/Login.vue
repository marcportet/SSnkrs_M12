      ...
      <div
        ...
        <div class="md:max-w-md w-full sm:px-6 py-4">
          <form @submit.prevent="submit">
            <div class="mb-8 flex">
              <a :href="route('home')">
                <svg class="w-[23px] h-[23px] text-gray-800 dark:text-white" style="height: 35;" aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#333333" viewBox="0 0 24 24">
              ...
              <svg class="w-[23px] h-[23px] text-gray-800 dark:text-white" aria-hidden="true"
                ...
                style="height: 37;">
                <path stroke="#333333" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                  d="m9 5 7 7-7 7" />
              </svg>
              <h3 class="text-3xl font-extrabold">Iniciar Sessión</h3>
            </div>
            <p class="text-sm mt-4 ">No tienes cuenta? <a :href="route('register')"
                class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Crea una cuenta aqui</a></p>
            <div class="mt-8">
              <InputLabel for="email" value="Email" class="text-xs block mb-2">Email</InputLabel>
              <div class="relative flex items-center">
                <TextInput id="email" type="email"
                  class="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none"
                  v-model="form.email" required autofocus autocomplete="username" placeholder="Enter email"></TextInput>
            ...
            <div class="mt-8">
              <InputLabel for="password" value="Password" class="text-xs block mb-2">Password</InputLabel>

              <div class="relative flex items-center">
                <TextInput id="password" type="password"
                  class="w-full text-sm border-b border-gray-300 focus:border-[#333] px-2 py-3 outline-none"
                  v-model="form.password" required autocomplete="current-password" placeholder="Enter password" />
