...
<template>
  <div class="bg-white">
    ...
    <header class="relative bg-white">
      <p class="flex m-0 h-6 items-center justify-center bg-blue-500 px-4 text-sm font-medium text-white sm:px-6 lg:px-8"></p>
          ...
          <div class="flex h-16 items-center">
            ...
            <PopoverGroup class="hidden lg:ml-8 lg:block lg:self-stretch" style="z-index: 3;">
              <div class="flex h-full space-x-8">
                <Popover v-for="category in navigation.categories" :key="category.name" class="flex" v-slot="{ open }" :placement="'top'">
    ...
    <footer class="bg-white">
      <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        ...
        <div
          class="grid grid-cols-1 gap-8 border-t border-gray-100 mt-4 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-8"
        >
          <div>
