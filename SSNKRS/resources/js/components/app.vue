      ...
      sections: [
        {
          ...
          name: 'Brands',
          items: [
            { name: 'Adidas', to: '/catalogo/ADIDAS' },
            { name: 'Air Jordan', to: '/catalogo/JORDAN' },
            { name: 'New Balance', to: '/catalogo/NEW BALANCE' },
            { name: 'Nike', to: '/catalogo/NIKE' },
            { name: 'Yeezy', to: '/catalogo/YEEZY' },
          ],
        },
      ],
    },
