    ...
    <div>
        ...
        <Dialog as="div" class="relative z-40 lg:hidden" @close="mobileFiltersOpen = false">
          ...
          <div class="fixed inset-0 z-40 flex">
            <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
              ...
              <DialogPanel
                class="relative ml-auto flex h-full w-full flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                ...
                <!-- Filters Mobil -->
                <form name="form_mobil" id="form_mobil" class="mt-4 border-t border-gray-200">
                  <h3 class="sr-only">Categories</h3>
                  <ul role="list" class="px-2 py-3 m-0 font-medium text-gray-900">
      ...
      <main class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-16">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900">Sneakers</h1>
        ...
        <section aria-labelledby="products-heading" class="pb-24 pt-6">
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            <!-- Filters PC -->
            <form name="form_pc" id="form_pc" class="hidden lg:block">
              <h3 class="sr-only">Categories</h3>
              <ul role="list" class="space-y-4 px-0 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900">
                <li v-for="category in subCategories" :key="category.name">
...
const filters = [
  {
    ...
    options: [
      ...
      { value: 'JORDAN', label: 'Air Jordan', checked: false },
